...
class Media
{
    ...
    private ?Folder $media_folder = null;
    ...
    {
        if (!$this->media_folder) {
            return null;
        }

        return $this->media_folder->getName();
    }

    public function setMediaFolder(?Folder $folder): static
    {
        $this->media_folder = $folder;
